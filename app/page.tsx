    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <nav className="border-b">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link href="/login" className="px-4 py-2 text-gray-700 hover:text-gray-900">Login</Link>
            <Link href="/register" className="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800">Sign Up</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center space-y-8">
          <h2 className="text-6xl font-bold">Multi-Vendor Marketplace</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Connect buyers with sellers. Built with Next.js, Stripe Connect, and modern web technologies.
          </p>
          <div className="flex gap-4 justify-center pt-8">
            <Link href="/shop" className="px-8 py-4 bg-black text-white rounded-lg text-lg hover:bg-gray-800">
              Browse Products
            </Link>
            <Link href="/vendor/register" className="px-8 py-4 border-2 border-black rounded-lg text-lg hover:bg-gray-50">
              Become a Vendor
            </Link>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          <div className="p-6 border rounded-lg">
            <h3 className="text-xl font-bold mb-2">🏪 Multi-Vendor</h3>
