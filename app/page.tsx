    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <nav className="bg-blue-600 border-b border-blue-700">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-white">MarketHub</h1>
          <div className="flex gap-4">
            <Link href="/login" className="px-4 py-2 text-white hover:text-blue-100">Login</Link>
            <Link href="/register" className="px-4 py-2 bg-white text-blue-600 rounded-lg hover:bg-blue-50">Sign Up</Link>
          </div>
        </div>
      </nav>
